...
- **Profile:** if `CLAUDE.local.md` exists at repo root, read it first for candidate facts; otherwise read `.claude/skills/job-application-assistant/01-candidate-profile.md`
