...
%     TITLE NAME
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{}{\Huge{[Your Full Name]}}{  \href{mailto:[your.email@example.com]}{[your.email@example.com]} | [+XX …] |  \urlstyle{same}\href{https://www.linkedin.com/in/[handle]}{LinkedIn}
}
...
- Adjust closing to local convention (e.g. "Saygılarımla," for Turkish)
