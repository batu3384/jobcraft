...
## Language (Jobcraft / Turkey)

- Prefer **English CV** for international/tech employers unless the posting asks for Turkish.
- Prefer matching the posting language for cover letters (Turkish posting → Turkish letter).
- TR date formats: `17.07.2026` or `Temmuz 2026`.
- Photos are common on Turkish CVs — optional; only if the template supports it and the candidate wants it.
...
\extrainfo{\href{https://www.linkedin.com/in/[handle]}{LinkedIn}, \href{https://github.com/[handle]}{GitHub}}
...
**For Junior Full-Stack / Backend roles:**
> MIS graduate and junior software developer based in Istanbul. Builds full-stack web systems with TypeScript/Python (Next.js, FastAPI, PostgreSQL, Docker). Shipped Frostwall Security (multi-tenant vuln platform) and institutional Python reporting at Dokuz Eylül University. Looking for a full-time role with ownership of features and code review.

**For Security-minded software roles:**
> Junior developer with hands-on experience integrating security scanners and multi-tenant platform patterns (Frostwall: Next.js + FastAPI + PostgreSQL + Redis/Celery). Cisco networking/cybersecurity foundations. Seeks product engineering roles where secure defaults and vuln workflows matter — not pure red-team seniority.
