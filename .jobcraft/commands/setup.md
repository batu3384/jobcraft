...
You are running the onboarding setup for the Jobcraft framework. Your goal is to collect the user's professional information and populate all profile files so the `/apply` workflow works out of the box.
...
**Deps gate (before anything else):** if `bun`, `lualatex`, or `xelatex` is missing from PATH, run `./install.sh` from the repo root (then `source scripts/jobcraft-env.sh`). Do not ask the user to install tools by hand — one script covers Bun, portal CLIs, poppler, and TinyTeX.

**Portal auth gate:** Yenibiriş needs a local browser cookie (Cloudflare). After install, if the user will `/scrape`, mention once: `./scripts/setup-portal-auth.sh` and `docs/portal-authentication.md`. Verify with `./scripts/doctor.sh`. Never ask the user to paste cookies into chat.
...
> **Welcome to the Jobcraft setup!**
>
> I'll help you build your professional profile so you can evaluate job postings, tailor CVs, write cover letters, and prepare for interviews.
>
...
- `.jobcraft/skills/job-application-assistant/01-candidate-profile.md`
- `.jobcraft/skills/job-application-assistant/02-behavioral-profile.md`
- `.jobcraft/skills/job-application-assistant/03-writing-style.md`
- `.jobcraft/skills/job-application-assistant/04-job-evaluation.md`
- `.jobcraft/skills/job-application-assistant/05-cv-templates.md`
- `.jobcraft/skills/job-application-assistant/06-cover-letter-templates.md`
- `.jobcraft/skills/job-application-assistant/07-interview-prep.md`
...
Then proceed to Step 3 to populate the non-skill files (`PROFILE.md`, `cv/main_example.tex`, `.jobcraft/skills/job-scraper/search-queries.md`). Step 3 will detect that the seven skill files are already populated and skip those substeps.
...
Ask about:
- **Role titles to search for:** "What job titles should I search for? For example: Data Scientist, ML Engineer, Software Engineer." Collect 3-8 specific titles.
...
- **Job portals:** "Jobcraft ships four Turkey-first search CLIs: `kariyer-net-search`, `yenibiris-search`, `eleman-net-search`, `linkedin-search`. Yenibiriş needs a one-time browser cookie — run `./scripts/setup-portal-auth.sh` (guide: `docs/portal-authentication.md`). Verify all portals: `./scripts/doctor.sh`. `/scrape` auto-discovers enabled portal skills under `.agents/skills/`."
...
### 8. Generate `.jobcraft/skills/job-scraper/search-queries.md`
...
>
> - `PROFILE.md` - Your full candidate profile
> - `.jobcraft/skills/job-application-assistant/01-candidate-profile.md` - Structured profile
> - `.jobcraft/skills/job-application-assistant/02-behavioral-profile.md` - Behavioral assessment
> - `.jobcraft/skills/job-application-assistant/04-job-evaluation.md` - Personalized evaluation framework
> - `.jobcraft/skills/job-application-assistant/05-cv-templates.md` - CV templates with your profile statements
> - `.jobcraft/skills/job-application-assistant/07-interview-prep.md` - STAR examples from your experience
> - `cv/main_example.tex` - Your LaTeX CV template
> - `.jobcraft/skills/job-scraper/search-queries.md` - Job search queries for `/scrape`
>
> **Try it out:**
