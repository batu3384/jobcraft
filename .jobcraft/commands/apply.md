...
- Extract: **company name**, **role title**, **department** (if mentioned), **location**, and **language** of the posting (Turkish or English).
...
- **Profile:** if `profile.local.md` exists at repo root, read it first for candidate facts; otherwise read `.jobcraft/skills/job-application-assistant/01-candidate-profile.md`
...
- **Match the language of the job posting** (Turkish posting -> Turkish cover letter, English posting -> English cover letter)
- Follow the structure from `06-cover-letter-templates.md`
- Use the `cover.cls` template
- Tailor the opening paragraph to the specific role and company
- Address to a named person if available in the posting, otherwise "Dear Hiring Manager" (or equivalent in posting language)
- Keep to approximately one page
- Any mention of agentic coding or AI tooling should reference **Jobcraft** or AI-assisted development in general — do not name third-party products unless the posting itself requires it
...
**3. Keyword coverage.** Reuse the required/preferred keyword list you extracted in Step 1 — do not re-derive it. Match each keyword against the extracted text, **in the posting's language** (a Turkish posting's keywords are matched in Turkish even though the CV may be in English — where the CV legitimately covers the concept in English, count it as synonym-only and note the language difference). Report a table:
...
Run the full verification checklist from `PROFILE.md` now — this is the **only** verification pass in the workflow. Re-read both files once here to verify final state on disk matches your mental model after the Step 4 and Step 5 edits.

### Verification Checklist
Report pass/fail for each item in the PROFILE.md verification checklist (factual accuracy, targeting, consistency, quality).
