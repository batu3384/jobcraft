...
description: >
  ...
  city, or remotely (Turkey defaults: Istanbul, Ankara, Izmir). Invoke for open
  positions, vacancies, hiring, iş ilanı, iş arama, açık pozisyon, İstanbul'da iş.
...
```bash
# Data engineer roles in Istanbul, last 30 days
bun run .agents/skills/linkedin-search/cli/src/cli.ts search -q "data engineer" -l "Istanbul, Turkey" --jobage 30 --format table

# Product manager roles in Ankara
bun run .agents/skills/linkedin-search/cli/src/cli.ts search -q "product manager" -l "Ankara, Turkey" --format table

# Any role, fully remote
bun run .agents/skills/linkedin-search/cli/src/cli.ts search -q "software engineer" -l "Remote" --format table
