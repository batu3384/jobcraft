...
const HELP = `yenibiris-cli — search jobs on yenibiris.com (Turkey)
...
SEARCH FLAGS
  --query, -q <text>   Keywords (e.g. yazilim gelistirici)
  --city, -c <text>    City slug (istanbul, ankara, izmir, bursa, antalya, kocaeli)
  --page <n>           Page number (default 1)
  --limit, -n <n>      Cap results
  --format <fmt>       json (default) | table | plain

Cloudflare: set YENIBIRIS_COOKIE from browser DevTools after visiting yenibiris.com.
